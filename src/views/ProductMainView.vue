...
<template>
    <div class="picture" :style="{ backgroundImage: 'url(src/images/hempview.png)' }" style="margin-top: 3rem; " >
        <div class="container-fluid picture" >
            <div class="text-center">      
            <h1 class="blackbold-text">{{ Data.whatis }} <span class="greenbold-text">{{ Data.hemp}}  </span></h1><br>  
          </div> 
          <div class="container">
    ...
    <div class="container full-height  ">
            <div class="row justify-content-center">
                ...
                <div class="col-md-5 d-flex align-items-center">
                    <div><br> 
                        <p><span class="black-text">{{ Data.our }}</span>  <span class="green-text">{{ Data.products }}</span></p>
                        <h5 class="blackbold-text">{{ Data.compositeTitle }}</h5>
                        <p> {{ Data.compositeDetails }} </p>              
                        <p class="button-details"  style="color:white"> {{ Data.moreDetails }}</p>
                    </div>  
                </div>
            </div>
        </div>
        ...
        <div class="container full-height  ">
            <div class="row justify-content-center">
                <div class="col-md-5 d-flex align-items-center">
                    <div><br> 
                        <p><span class="black-text">{{ Data.our }}</span>  <span class="green-text">{{ Data.products }}</span></p>
                        <h5 class="blackbold-text">{{ Data.plasticTitle }}</h5>
                        <p> {{ Data.plasticDetails }} </p>
                        <p class="button-details"  style="color:white"> {{ Data.moreDetails }}</p>
                    </div>
                </div>
                <div class="col-md-6">
